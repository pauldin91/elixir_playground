defmodule FileUploadDemoWeb.PersonLiveTest do
  use FileUploadDemoWeb.ConnCase

  import Phoenix.LiveViewTest
  import FileUploadDemo.PeopleFixtures

  @create_attrs %{name: "some name", bitrhdate: "2025-12-04T14:52:00Z"}
  @update_attrs %{name: "some updated name", bitrhdate: "2025-12-05T14:52:00Z"}
