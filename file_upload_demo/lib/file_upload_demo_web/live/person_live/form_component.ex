defmodule FileUploadDemoWeb.PersonLive.FormComponent do
  use FileUploadDemoWeb, :live_component
  ...
  def render(assigns) do
    ...
    <div>
      ...
      >
        ...
        <.input field={@form[:bitrhdate]} type="datetime-local" label="Bitrhdate" />
        <:actions>
