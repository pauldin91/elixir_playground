defmodule TakeANumberDeluxe do
  ...
  def start_link(init_arg) do
    ...
    cond do
      :ok == status ->
        GenServer.start_link(__MODULE__, state, name: Keyword.get(init_arg, :registered_name))
  ...
  def handle_cast({:reset, new_state}, _old_state) do
    case TakeANumberDeluxe.State.new(
           new_state.min_number,
           new_state.max_number,
           new_state.auto_shutdown_timeout
         ) do
